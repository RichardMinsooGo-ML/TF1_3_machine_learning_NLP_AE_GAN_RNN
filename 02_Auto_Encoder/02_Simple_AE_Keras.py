...
my_regularizer = None
my_epochs = 50
features_path = '/tmp/AutoEncoder/simple_autoe_features.pickle'
labels_path = '/tmp/AutoEncoder/simple_autoe_labels.pickle'
...
if use_regularizer:
    ...
    my_epochs = 100
    features_path = '/tmp/AutoEncoder/sparse_autoe_features.pickle'
    labels_path = '/tmp/AutoEncoder/sparse_autoe_labels.pickle'
