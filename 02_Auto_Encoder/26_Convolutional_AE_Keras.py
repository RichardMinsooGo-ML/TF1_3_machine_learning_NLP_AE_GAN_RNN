...
autoencoder.fit(x_train, x_train, epochs=10, batch_size=128, shuffle=True, validation_data=(x_test, x_test),
                callbacks=[TensorBoard(log_dir='/tmp/AutoEncoder/conv_autoencoder')], verbose=2)
...
pickle.dump(encoded_imgs, open('/tmp/ML/12_Auto_Encoder/conv_autoe_features.pickle', 'wb'))
