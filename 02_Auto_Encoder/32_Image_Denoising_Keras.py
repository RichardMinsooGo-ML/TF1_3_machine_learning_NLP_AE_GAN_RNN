...
autoencoder.fit(x_train_noisy, x_train, epochs=100, batch_size=128, shuffle=True,
                ...
                callbacks=[TensorBoard(log_dir='/tmp/AutoEncoder/noisy', histogram_freq=0, write_grads=False)])
...
pickle.dump(encoded_imgs, open('/tmp/AutoEncoder/denoise_autoe_features.pickle', 'wb'))
