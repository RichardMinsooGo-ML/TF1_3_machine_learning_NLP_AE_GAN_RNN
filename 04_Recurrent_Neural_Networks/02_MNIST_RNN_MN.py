...
# RNN 셀을 생성합니다.
cell1 = tf.nn.rnn_cell.BasicLSTMCell(H_SIZE_01)
...
cell2 = tf.nn.rnn_cell.BasicLSTMCell(H_SIZE_01)

cell2 = tf.nn.rnn_cell.DropoutWrapper(cell2, output_keep_prob=0.7)
# 여러개의 셀을 조합해서 사용하기 위해 셀을 추가로 생성합니다.
cell3 = tf.nn.rnn_cell.BasicLSTMCell(H_SIZE_01)
