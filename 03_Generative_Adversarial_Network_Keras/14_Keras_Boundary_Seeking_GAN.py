...
LOG_DIR_Model = "/tmp/ML/13_Generative_Adversarial_Network/Boundary_Seeking_GAN/Model"
LOG_DIR_Graph = "/tmp/ML/13_Generative_Adversarial_Network/Boundary_Seeking_GAN/Graph"
    ...
    def train(self, N_EPISODES, batch_size=128, sample_interval=50):
        ...
        for episode in range(N_EPISODES):
            ...
            if (episode+1) % Print_Cycle == 0:
                print ("[Episodes: %6d] [D loss: %2.6f, acc.: %2.2f%%] [G loss: %2.6f]" % ((episode+1), d_loss[0], 100*d_loss[1], g_loss))
...
if __name__ == '__main__':
    ...
    bgan = BGAN()
    bgan.train(N_EPISODES=5000, batch_size=32, sample_interval=200)
