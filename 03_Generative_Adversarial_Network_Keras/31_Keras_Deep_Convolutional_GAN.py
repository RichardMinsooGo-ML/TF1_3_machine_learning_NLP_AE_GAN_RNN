...
LOG_DIR_Model = "/tmp/ML/13_Generative_Adversarial_Network/Deep_Convolution_GAN/Model"
LOG_DIR_Graph = "/tmp/ML/13_Generative_Adversarial_Network/Deep_Convolution_GAN/Graph"
    ...
    def train(self, N_EPISODES, batch_size=128, sample_interval=50):
        ...
        for episode in range(N_EPISODES):
            ...
            if (episode+1) % sample_interval == 0:
                self.save_model()
                self.save_imgs(episode)

    def save_imgs(self, episode):
        _Row, _Column = 5, 5
...
if __name__ == '__main__':
    ...
    dcgan = DCGAN()
    dcgan.train(N_EPISODES=5000, batch_size=32, sample_interval=200)
