...
LOG_DIR_Model = "/tmp/ML/13_Generative_Adversarial_Network/Least_Squares_GAN/Model"
LOG_DIR_Graph = "/tmp/ML/13_Generative_Adversarial_Network/Least_Squares_GAN/Graph"
